      ...
      <div className="print-ticket-page">
        <div className="print-ticket">
          ...
          <div className="ticket-row">
            ...
            <span className="ticket-row-value">{shortDate(ticket.entryAt)}, {shortTime(ticket.entryAt)}</span>
          </div>
          <div className="ticket-row">
          ...
          <div className="ticket-row">
            ...
            <span className="ticket-row-value">{ticket.entryOperatorName || ticket.cashierName || '-'}</span>
          </div>
          <div className="ticket-dashed" />
